		...
		if (weekUnlocked[curWeek])
		{
			...
			switch(curWeek){
				...
				case 6:
					...
					trace('loaded week 6 music');
				case 7:
					FlxG.sound.cache(Paths.inst('ugh'));
					FlxG.sound.cache(Paths.voices('ugh'));
		
					FlxG.sound.cache(Paths.inst('guns'));
					FlxG.sound.cache(Paths.voices('guns'));
		
					FlxG.sound.cache(Paths.inst('stress'));
					FlxG.sound.cache(Paths.voices('stress'));
					trace('loaded week 7 music');
			}
